...
La prise en main des déploiements d’expérience comprend trois étapes : recherche ou création de votre équipe, demande d’accès et connexion à la console.
...
## Connexion à la console {#log-in-steps}
...
Après vous être connecté, vérifiez que votre application est répertoriée dans la console. Les applications sont gérées par les administrateurs de l’équipe. Si votre application n’est pas répertoriée, contactez l’administrateur de votre équipe pour l’ajouter. Pour plus d’informations, consultez [Gestion des applications](../applications/manage-applications.md).
