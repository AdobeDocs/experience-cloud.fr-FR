...
* Surveillez toutes les actions ou séquences d’actions sur votre site dont vous souhaitez effectuer le suivi. Vous obtiendrez de précieuses informations sur le comportement des utilisateurs et utilisatrices, et vous pourrez optimiser l’expérience client en fonction de leurs actions.
